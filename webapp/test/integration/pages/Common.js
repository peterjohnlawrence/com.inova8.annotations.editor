sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/inova8/annotations/app", ".html");
		...
		return Opa5.extend("com.inova8.annotations.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/inova8/annotations/localService/mockserver"], function (mockserver) {
