sap.ui.define([
	...
	return BaseController.extend("com.inova8.annotations.editor.controller.Worklist", {
		...
		onInit: function() {
			...
			sap.ui.getCore().setModel(this.getOwnerComponent().getModel("prefixes"), "prefixes");
		...
		onPress: function(oEvent) {
			...
			// TODO modify to find row path of substanceAnnotation
		...
		onSearch: function(oEvent) {
			if (oEvent.getParameters().refreshButtonPressed) {
				...
				if (sQuery && sQuery.length > 0) {
					oTableSearchState = [new Filter("substanceAnnotation_bodyText", FilterOperator.Contains, sQuery)];
				}
		...
		_showObject: function(oItem) {
			this.getRouter().navTo("object", {
				objectId: oItem.getBindingContext().getProperty("subjectId")
			});
		},
